...
/**
 * Općenita kolekcija elemenata koja sadrži metode za dohvat 
 * informacija i metode za manipulaciju elemenata ove kolekcije.
 * 
 * @author Tomislav Bjelčić
 * @param <E> tip elemenata ove kolekcije.
 */
public interface Collection<E> {
	...
	/**
	 * Dodaje predani element {@code value} u ovu kolekciju.
	 * 
	 * @param value element kojeg želimo dodati u kolekciju.
	 */
	void add(E value);
	 ...
	 */
	default void addAll(Collection<? extends E> col) {
		Objects.requireNonNull(col, "Predana kolekcija je null.");
		
		Processor<E> adder = this::add;
		col.forEach(adder);
	}
