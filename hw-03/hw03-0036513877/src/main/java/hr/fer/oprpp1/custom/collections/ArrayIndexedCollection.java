 ...
 * @params <E> tip elemenata ove liste.
 *
 */
public class ArrayIndexedCollection<E> implements List<E> {
	...
	private static class ArrayListElementsGetter<E> implements ElementsGetter<E> {
		...
		ArrayListElementsGetter(ArrayIndexedCollection<E> list) {
			this.list = list;
		...
		public E getNextElement() {
			...
			E element = list.elements[currentPosition];
			currentPosition++;
			return element;
		}
	...
	private void doubleCapacity() {
		...
		E[] doubledCapacityCopiedArray = Arrays.copyOf(elements, doubledCapacity);
	...
	/**
	 * Vraća trenutni kapacitet polja.<br>
	 * Ova metoda se koristi samo za potrebe testiranja.
	 * 
	 * @return trenutni kapacitet polja.
	 */
